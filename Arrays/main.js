...
//
// 1- Normal Method
let normalArray = ["By", "Normal", "Array", "method"];
console.log(normalArray);
//
//
// 2- Constructor Method
let constructorArray = new Array("By", "Constructor", "Array", "Method");
console.log(constructorArray);
//
//
// 3- Array Method
let arrayMethod = Array.of("By", "Array", "Method");
